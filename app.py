...
def load_data():
    ...
    # LETO kot navaden int (ne Int64!) — pomembno za multiselect
    if "LETO" in df.columns:
        df["LETO"] = df["LETO"].dropna()
    ...
    # Reset index — vsak posel je svoja neodvisna vrstica
...
# Vse vrstice, brez deduplikacije — vsak posel posebej
